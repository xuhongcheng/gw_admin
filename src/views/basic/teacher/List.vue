...
<!--            </el-form-item>-->
            <el-form-item label="">
              <el-input size="small" v-model="searchData.name" placeholder="请输入教师名称"></el-input>
            </el-form-item>
            <el-form-item>
...
<!--            </el-table-column>-->
            ...
            <el-table-column label="教龄" align="center">
              <template slot-scope="scope">
...
<script>
  export default {
    ...
    methods: {
      ...
      hanldeAdd() {  // 添加
        this.$router.push('/basic/teacher/add')
      },
      showModal() {
        this.visible = true
      },
      ...
      handleEdit(index, id) {
        ...
        this.$router.push('/basic/teacher/' + id)
      },
      handleSuccess(data) {
        console.log(data)
        this.visible = false
