    ...
    <div class="form">
      <el-form ref="checkForm" :model="form" label-width="150px">
        <el-form-item label="教师姓名">
          <el-input type="text" v-model="form.name" placeholder="请输入账号名称"></el-input>
        </el-form-item>
        ...
        <el-form-item label="国籍">
          <el-select v-model="form.sex" placeholder="请选择国籍">
            <el-option label="中国" :value="1"></el-option>
            <el-option label="美国" :value="2"></el-option>
            <el-option label="德国" :value="3"></el-option>
            <el-option label="英国" :value="4"></el-option>
        ...
        <el-form-item label="职教日期">
          <el-date-picker type="date" placeholder="选择职教日期" v-model="form.date"></el-date-picker>
        </el-form-item>
