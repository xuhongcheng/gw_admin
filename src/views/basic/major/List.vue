...
<!--            </el-form-item>-->
            ...
            <el-form-item>
              <el-select size="small" v-model="searchData.college" clearable placeholder="请选择所属学院">
...
<!--            </el-table-column>-->
            ...
            <el-table-column label="所属学院" align="center">
              <template slot-scope="scope">
                <span>{{ college(scope.row.college) }}</span>
              </template>
            </el-table-column>
...
<script>
  export default {
    ...
    methods: {
      ...
      hanldeAdd() {  // 添加
        this.$router.push('/basic/major/add')
      },
      showModal() {
        this.visible = true
      },
      ...
      handleEdit(index, id) {
        ...
        this.$router.push('/basic/major/' + id)
      },
      handleSuccess(data) {
        console.log(data)
        this.visible = false
