...
<!--            </el-form-item>-->
            <el-form-item label="">
              <el-input size="small" v-model="searchData.name" placeholder="请输入系部名称"></el-input>
            </el-form-item>
            <el-form-item label="">
...
<!--              </template>-->
<!--            </el-table-column>-->
            <el-table-column label="系部代码" align="center">
              <template slot-scope="scope">
...
<script>
  export default {
    ...
    methods: {
      ...
      hanldeAdd() {  // 添加
        this.$router.push('/basic/department/add')
      },
      showModal() {
        this.visible = true
      },
      ...
      handleEdit(index, id) {
        ...
        this.$router.push('/basic/department/' + id)
      },
      handleSuccess(data) {
        console.log(data)
        this.visible = false
