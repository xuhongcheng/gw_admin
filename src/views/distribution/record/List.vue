      ...
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <el-form-item label="">
              <el-input size="small" v-model="searchData.name" placeholder="礼券名称、姓名或电话"></el-input>
            </el-form-item>
<!--            <el-form-item>-->
...
<!--            </el-table-column>-->
            ...
            <el-table-column label="兑换状态" width="100" align="center">
              <template slot-scope="scope">
                <span v-if="scope.row.state === 1 || scope.row.state === 2" :class="{'success-state': scope.row.state === 1, 'error-state': scope.row.state === 2}">{{state_list[scope.row.state]}}</span>
...
<script>
  export default {
    ...
    methods: {
      ...
      download () {
        location.href = 'http://gzlouvre.globalviewcco.com/file/礼券名单.xls'
