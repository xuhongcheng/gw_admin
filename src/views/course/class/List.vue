      ...
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <!--            </el-form-item>-->
            <el-form-item label="">
              <el-input size="small" v-model="searchData.name" placeholder="请输入分类名称"></el-input>
            </el-form-item>
            <el-form-item label="">
...
<script>
  export default {
    ...
    methods: {
      ...
      hanldeAdd() {  // 添加
        this.$router.push('/course/class/add')
      },
      showModal() {
        this.visible = true
      },
      ...
      handleEdit(index, id) {
        ...
        this.$router.push('/course/class/' + id)
      },
      handleSuccess(data) {
        console.log(data)
        this.visible = false
